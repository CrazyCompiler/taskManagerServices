...
const (
	dbInsertQuery string = "insert into tasks(task,priority,userid)  VALUES($1,$2,$3);"
	dbDeleteQuery string = "delete from tasks where taskid=$1 and userid = $2"
	dbUpdateQuery string = "update tasks set task=$1,priority=$2 where taskid=$3 and userid = $4;"
)
